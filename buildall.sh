...
THRIFT_VERSION=0.16.0-p5 $SOURCE_DIR/source/thrift/build.sh
...
(
  export BOOST_VERSION=1.74.0-p1
  export KUDU_VERSION=7206a9f4fbf905472bb9f6b4fb0c450e6b437922
  export KUDU_GITHUB_URL=https://github.infra.cloudera.com/michaelsmith/kudu.git
